	...
	Describe("ParseAndApplyDefaults", func() {
		...
		DescribeTable("parsing and applying defaults",
			...
			Entry("with multiple bindings", testCase{
				...
				includeObjects:   true,
				includeTemplate:  true,
				args:             []any{bindings, moreBindings},
			...
			Entry("merging with defaults", testCase{
				...
				includeObjects:   true,
				includeTemplate:  true,
				args:             []any{ten, two, templateContent, moreBindings, overrideBindings},
				expectedOpts: &options.Options{
					Timeout:  ten,
					Interval: two,
			...
			Entry("error with multiple templates", testCase{
				defaults:         nil,
				includeDurations: false,
				includeObject:    false,
				includeObjects:   false,
				includeTemplate:  true,
				args:             []any{templateContent, templateContent},
				expectedOpts:     nil,
				expectedErr:      errors.New("multiple template arguments provided"),
			}),
			Entry("error with multiple client.Object arguments", testCase{
				...
				includeObjects:   false,
				includeTemplate:  false,
				args:             []any{typedObj, unstructuredObj},
				expectedOpts:     nil,
			...
			Entry("error with unexpected string", testCase{
				...
				args:             []any{templateContent},
				expectedOpts:     nil,
				expectedErr:      errors.New("unexpected argument type: string"),
			}),
			Entry("error with unexpected duration", testCase{
				defaults:         nil,
				includeDurations: false,
				includeObject:    false,
				includeObjects:   false,
				...
				args:             []any{ten},
				expectedOpts:     nil,
				expectedErr:      errors.New("unexpected argument type: time.Duration"),
			}),
			Entry("error with unexpected client.Object", testCase{
				defaults:         nil,
				includeDurations: false,
				includeObject:    false,
				includeObjects:   false,
				...
				args:             []any{typedObj},
				expectedOpts:     nil,
				expectedErr:      errors.New("unexpected argument type: *v1.ConfigMap"),
			}),
			Entry("error with unexpected []client.Object", testCase{
				defaults:         nil,
				includeDurations: false,
